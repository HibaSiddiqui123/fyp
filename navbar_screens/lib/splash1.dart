...
int ? isLogin;
  ...
  void initState() {
    ...
    Timer(
        const Duration(seconds: 100000000000000),
          ...
          Container(
            ...
            child:
              ...
              Center(
                child: RichText(
                    text: const TextSpan(
                        ...
                        children: <TextSpan>[
                      TextSpan(
                          text: '" Give us freedom not feardom! "\n\n',
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.pinkAccent,
                              fontSize: 20)),
                      TextSpan(
                          ...
                          style: TextStyle(
                              ...
                              fontSize: 15)),
                      TextSpan(
                          text: ' Millions of people use to turn\n',
                          style: TextStyle(
                              height: 1.5,
                              fontStyle: FontStyle.normal,
                              fontWeight: FontWeight.bold,
              ...
              Expanded(
                ...
                child: Image.asset('assets/womyn0.jpg',
                    width: 270.w, height: 270.h),
              ))
            ]),
          ),
          Center(
